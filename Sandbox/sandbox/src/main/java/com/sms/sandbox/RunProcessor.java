...
public class RunProcessor {
	public static void main(String [] args) {
        ...
        RunProcessor m = new RunProcessor();
        Arrays.sort(staticFunctionRef, Comparator.comparing(m::firstNameNonStatic));
        Arrays.sort(instanceFunctionRef, Comparator.comparing(RunProcessor::firstName));
        ...
        Arrays.sort(staticFunctionRef, Comparator.comparing(RunProcessor::firstName).reversed());
        System.out.println("Reversed Static function reference: " + (Arrays.toString(staticFunctionRef)));

        Arrays.sort(names, Comparator.comparing(RunProcessor::firstName).thenComparing(RunProcessor::title));
